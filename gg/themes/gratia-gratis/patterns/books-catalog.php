...
<div class="wp-block-group alignfull gg-books-catalog has-parchment-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group alignwide gg-books-group">
		<!-- wp:group {"align":"wide","className":"gg-books-group-heading","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
		<div class="wp-block-group alignwide gg-books-group-heading"><!-- wp:heading {"fontSize":"x-large"} --><h2 class="wp-block-heading has-x-large-font-size">Published</h2><!-- /wp:heading --><!-- wp:paragraph {"className":"gg-eyebrow"} --><p class="gg-eyebrow">Available now</p><!-- /wp:paragraph --></div>
		<!-- /wp:group -->

		<!-- wp:query {"queryId":51,"query":{"perPage":100,"pages":0,"offset":0,"postType":"book","order":"asc","orderBy":"menu_order","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"include":{"book_status":[<?php echo absint( $published_id ); ?>]}}},"align":"wide","className":"gg-books-query gg-books-query--published"} -->
		<div class="wp-block-query alignwide gg-books-query gg-books-query--published"><!-- wp:post-template {"className":"gg-book-grid","layout":{"type":"grid","columnCount":3}} -->
	...
	<div class="wp-block-group alignwide gg-books-group" style="margin-top:var(--wp--preset--spacing--70)">
		<!-- wp:group {"align":"wide","className":"gg-books-group-heading","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
		<div class="wp-block-group alignwide gg-books-group-heading"><!-- wp:heading {"fontSize":"x-large"} --><h2 class="wp-block-heading has-x-large-font-size">Coming soon</h2><!-- /wp:heading --><!-- wp:paragraph {"className":"gg-eyebrow"} --><p class="gg-eyebrow">In translation</p><!-- /wp:paragraph --></div>
		<!-- /wp:group -->

		<!-- wp:query {"queryId":52,"query":{"perPage":100,"pages":0,"offset":0,"postType":"book","order":"asc","orderBy":"menu_order","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"include":{"book_status":[<?php echo absint( $coming_id ); ?>]}}},"align":"wide","className":"gg-books-query gg-books-query--coming-soon"} -->
		<div class="wp-block-query alignwide gg-books-query gg-books-query--coming-soon"><!-- wp:post-template {"className":"gg-book-grid","layout":{"type":"grid","columnCount":3}} -->
		<!-- wp:group {"className":"gg-book-card","layout":{"type":"default"}} -->
		<div class="wp-block-group gg-book-card"><!-- wp:post-featured-image {"isLink":true,"sizeSlug":"large","className":"gg-book-cover"} /--><!-- wp:post-title {"isLink":true,"level":3,"className":"gg-book-title","fontSize":"large"} /--><!-- wp:group {"className":"gg-book-info","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} --><div class="wp-block-group gg-book-info"><!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"core/post-meta","args":{"key":"book_author"}}}},"className":"gg-meta"} --><p class="gg-meta"></p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"metadata":{"bindings":{"url":{"source":"core/post-meta","args":{"key":"book_url"}},"text":{"source":"core/post-meta","args":{"key":"book_link_label"}}}},"className":"gg-book-action"} --><div class="wp-block-button gg-book-action"><a class="wp-block-button__link wp-element-button">Learn more ↗</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:group --></div>
		<!-- /wp:group -->
