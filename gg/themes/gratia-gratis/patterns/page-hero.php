 ...
 * Description: Dynamic title and excerpt for standard pages.
 */
?>
...
<div class="wp-block-group alignfull gg-page-hero has-parchment-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<!-- wp:column {"verticalAlignment":"bottom","width":"68%"} --><div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:68%"><!-- wp:post-title {"level":1,"fontSize":"display"} /--><!-- wp:post-excerpt {"moreText":"","showMoreOnNewLine":false,"fontSize":"large"} /--></div><!-- /wp:column --></div>
	<!-- /wp:columns -->
</div>
<!-- /wp:group -->
